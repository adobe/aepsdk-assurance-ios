...
class AssuranceEventTests: XCTestCase {
    ...
    func test_fromMobileCoreEvent() throws {
        ...
        XCTAssertEqual("coreSource", assuranceEvent.payload?[AssuranceConstants.ACPExtensionEventKey.SOURCE]?.stringValue?.lowercased())
        XCTAssertEqual("coreType", assuranceEvent.payload?[AssuranceConstants.ACPExtensionEventKey.TYPE]?.stringValue.lowercased())
