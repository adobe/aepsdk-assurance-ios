...
class MockQuickConnectManager: QuickConnectManager {
    override init(stateManager: AssuranceStateManager, uiDelegate: AssurancePresentationDelegate) {
        super.init(stateManager: stateManager, uiDelegate: uiDelegate)
    }
    
    var createDeviceCalled = false
    override func createDevice() {
